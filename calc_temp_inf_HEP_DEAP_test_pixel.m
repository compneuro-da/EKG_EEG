...
%ntr = ntime_info; % number of triplets
%pcorr = pval*6/(ntr*(ntr-1)*(ntr-2)); % Bonferroni correction for triplets (from https://github.com/compneuro-da/interactioninformation/blob/master/main_interaction_information_pwp.m)
...
cratings_tot = copnorm(labels_tot(:,3)); % choose a label
%%
...
colorbar
axis square
caxis([-0.0035,0.0035]) % see plots in calc_temp_inf_HEP_DEAP.m
