...
% second loop
for iperm = 1:nperm
    % threshold the null hypothesis maps
    perms = true(1,nperm);
    perms(iperm) = 0;
    zvals = squeeze((hp(:,:,iperm) - mean(hp(:,:,perms),3)) ./ std(hp(:,:,perms),[],3)); % see MxC chapter 33 equation 33.1
